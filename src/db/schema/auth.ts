/* =========================================================================
 * SCHEMA "auth" - tabel inti Better Auth (user, session, account, verification).
 * Nama tabel & kolom mengikuti konvensi default Better Auth agar
 * drizzleAdapter bisa auto-mapping tanpa konfigurasi manual.
 * ========================================================================= */
